...
(function () {
  ...
  /* nav border + back to top, both driven off "has the intro
     section scrolled out of view" rather than a scroll listener */
  var nav = document.querySelector(".nav");
  var totop = document.getElementById("totop");
  var intro = document.querySelector(".hero, .pagehero");
  if (intro && "IntersectionObserver" in window) {
    var introObs = new IntersectionObserver(
      function (entries) {
        entries.forEach(function (en) {
          var past = !en.isIntersecting;
  ...
  /* ============================================================
     ...
     far down the page you are. Driven entirely by a CSS scroll
     timeline (see .scrollbar in styles.css), so there is no
     scroll listener here at all; browsers without support for
     scroll-driven animations simply never show the bar.
     ============================================================ */
  (function progress(){
  ...
  (function exitIntent(){
    ...
    /* touch fallback, one calm nudge once the footer approaches,
       a stand in for "scrolled deep into the page" with no
       scroll listener */
